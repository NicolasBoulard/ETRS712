...
--
-- Hôte : mysql:3306
-- Généré le : mer. 12 jan. 2022 à 21:41
...
--
-- Structure de la table `bot_passwords`
--
...
--
-- Structure de la table `change_tag_def`
--
...
(1, 869, 0x3478747735367861357a7437777639366732677235386c6e74627664357a70, 1, 0x74743a31);

-- --------------------------------------------------------

--
-- Structure de la table `content_models`
--
...
--
-- Déchargement des données de la table `content_models`
--
...
--
-- Déchargement des données de la table `interwiki`
--
...
--
-- Structure de la table `ipblocks_restrictions`
--
...
--
-- Structure de la table `ip_changes`
--
...
--
-- Déchargement des données de la table `logging`
--
...
(1, 0x637265617465, 0x637265617465, 0x3230323230313132323134313435, 2, 0, 0x4163637565696c, 1, 1, 0x613a313a7b733a31373a226173736f6369617465645f7265765f6964223b693a313b7d, 0);
...
(1, 0, 0x4163637565696c, '', 0, 1, 0.629153983218, 0x3230323230313132323134313435, NULL, 1, 869, 0x77696b6974657874, NULL);
...
(1, 1, 0, 0, 0x3230323230313132323134313435, 0, 0, 869, 0, 0x3478747735367861357a7437777639366732677235386c6e74627664357a70);

-- --------------------------------------------------------

--
-- Structure de la table `revision_actor_temp`
--
...
--
-- Déchargement des données de la table `revision_actor_temp`
--

INSERT INTO `revision_actor_temp` (`revactor_rev`, `revactor_actor`, `revactor_timestamp`, `revactor_page`) VALUES
(1, 2, 0x3230323230313132323134313435, 1);

-- --------------------------------------------------------

--
-- Structure de la table `revision_comment_temp`
--
...
--
-- Déchargement des données de la table `revision_comment_temp`
--
...
--
-- Structure de la table `slot_roles`
--
...
--
-- Déchargement des données de la table `slot_roles`
--
...
(1, , 0x7574662d38);
...
--
-- Déchargement des données de la table `updatelog`
--
...
(1, 0x41646d696e, '', , '', NULL, 0x61646d696e406c6f63616c686f7374, 0x3230323230313132323134313436, 0x3664383932653534336263623730373838386362383965306361383362353631, NULL, NULL, NULL, 0x3230323230313132323134313435, 0, NULL),
(2, 0x4d6564696157696b692064656661756c74, '', '', '', NULL, '', 0x3230323230313132323134313435, 0x2a2a2a20494e56414c4944202a2a2a0000000000000000000000000000000000, NULL, NULL, NULL, 0x3230323230313132323134313435, 0, NULL);
...
--
-- Structure de la table `watchlist_expiry`
--
...
--
-- Index pour la table `bot_passwords`
--
...
--
-- Index pour la table `categorylinks`
--
...
--
-- Index pour la table `change_tag`
--
...
--
-- Index pour la table `change_tag_def`
--
...
--
-- Index pour la table `content_models`
--
...
--
-- Index pour la table `externallinks`
--
...
--
-- Index pour la table `filearchive`
--
...
--
-- Index pour la table `imagelinks`
--
...
--
-- Index pour la table `interwiki`
--
ALTER TABLE `interwiki`
  ADD PRIMARY KEY (`iw_prefix`);

--
-- Index pour la table `ipblocks`
--
...
--
-- Index pour la table `ipblocks_restrictions`
--
...
--
-- Index pour la table `ip_changes`
--
...
--
-- Index pour la table `l10n_cache`
--
ALTER TABLE `l10n_cache`
  ADD PRIMARY KEY (`lc_lang`,`lc_key`);

--
-- Index pour la table `langlinks`
--
...
--
-- Index pour la table `log_search`
--
...
--
-- Index pour la table `module_deps`
--
ALTER TABLE `module_deps`
  ADD PRIMARY KEY (`md_module`,`md_skin`);

--
-- Index pour la table `objectcache`
--
...
--
-- Index pour la table `page_props`
--
...
--
-- Index pour la table `page_restrictions`
--
...
--
-- Index pour la table `protected_titles`
--
...
--
-- Index pour la table `querycache`
--
ALTER TABLE `querycache`
  ADD KEY `qc_type` (`qc_type`,`qc_value`);

--
-- Index pour la table `querycachetwo`
--
...
--
-- Index pour la table `querycache_info`
--
ALTER TABLE `querycache_info`
  ADD PRIMARY KEY (`qci_type`);

--
-- Index pour la table `recentchanges`
--
...
--
-- Index pour la table `revision_actor_temp`
--
ALTER TABLE `revision_actor_temp`
...
--
-- Index pour la table `revision_comment_temp`
--
...
--
-- Index pour la table `site_identifiers`
--
...
--
-- Index pour la table `slot_roles`
--
...
--
-- Index pour la table `templatelinks`
--
...
--
-- Index pour la table `updatelog`
--
ALTER TABLE `updatelog`
  ADD PRIMARY KEY (`ul_key`);

--
-- Index pour la table `uploadstash`
--
...
--
-- Index pour la table `user_former_groups`
--
...
--
-- Index pour la table `user_newtalk`
--
...
--
-- Index pour la table `watchlist_expiry`
--
...
--
-- AUTO_INCREMENT pour la table `change_tag`
--
ALTER TABLE `change_tag`
  MODIFY `ct_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `change_tag_def`
--
ALTER TABLE `change_tag_def`
...
--
-- AUTO_INCREMENT pour la table `content_models`
--
ALTER TABLE `content_models`
  MODIFY `model_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `externallinks`
--
ALTER TABLE `externallinks`
  MODIFY `el_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `filearchive`
--
ALTER TABLE `filearchive`
  MODIFY `fa_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `ipblocks`
--
ALTER TABLE `ipblocks`
...
--
-- AUTO_INCREMENT pour la table `page_restrictions`
--
ALTER TABLE `page_restrictions`
  MODIFY `pr_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `recentchanges`
--
ALTER TABLE `recentchanges`
...
--
-- AUTO_INCREMENT pour la table `slot_roles`
--
ALTER TABLE `slot_roles`
...
--
-- AUTO_INCREMENT pour la table `uploadstash`
--
ALTER TABLE `uploadstash`
